...
return [
    ...
    */
    ...
    'ascii' => 'يجب أن يحتوي حقل :attribute على أحرف أبجدية ورموز أحرف أساسية فقط.',
    ...
    'confirmed' => 'كلمة السر غير متطابقة مع تأكيد كلمة السر',
    ...
    'extensions' => 'يجب أن يكون لحقل :attribute إمتداد أحد الأنواع التالية: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'قد ظهرت :attribute المعطاة في تسريب بيانات. الرجاء اختيار :attribute مختلفًا.',
    ],
    ...
    'required' => 'هذا الحقل مطلوب لا يمكن ان يكون فارغ .',
    'required_array_keys' => 'يجب أن تحتوي مفاتيح مصفوفة :attribute على الإدخالات التالية: :values.',
    ...
    'timezone' => 'يجب أن يكون حقل :attribute مدينة صالحة.',
